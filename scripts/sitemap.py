...
Usage:
    python scripts/sitemap.py              # write to build/site-map.json
    python scripts/sitemap.py --pretty     # human-readable JSON
    python scripts/sitemap.py --stdout     # print to stdout instead of file
"""
