...
Usage:
    python scripts/tailor.py data/jobs/revolut-pm.txt
    python scripts/tailor.py data/jobs/brief.docx --type cv --id my-cv
    python scripts/tailor.py data/jobs/brief.md --no-ai
"""
